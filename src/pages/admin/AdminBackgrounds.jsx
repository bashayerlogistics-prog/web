...
const BACKGROUND_OPTIONS = [
  ...
  {
    id: 'home-instant-price-desktop',
    pageEn: 'Home page',
    pageAr: 'الصفحة الرئيسية',
    sectionEn: 'Instant price — desktop',
    sectionAr: 'السعر الفوري — كمبيوتر',
    source: 'instantPrice',
  ...
  {
    id: 'home-instant-price-mobile',
    pageEn: 'Home page',
    pageAr: 'الصفحة الرئيسية',
    sectionEn: 'Instant price — mobile',
    sectionAr: 'السعر الفوري — جوال',
    source: 'instantPrice',
    field: 'backgroundImageMobileUrl',
    width: 768,
    height: 1280,
    folder: 'backgrounds/instant-price',
    device: 'mobile',
